...
namespace CodeProdigee.API.Migrations
{
    ...
    [Migration("20220102220627_BlogDbInit")]
    partial class BlogDbInit
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CodeProdigee.API.Models.CommentReply", b =>
                {
                    b.HasOne("CodeProdigee.API.Models.Comment", "Comment")
                        .WithMany("Replies")
                        .HasForeignKey("CommentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CodeProdigee.API.Models.Commentator", null)
            ...
            modelBuilder.Entity("CodeProdigee.API.Models.Reaction", b =>
                {
                    ...
                    b.HasOne("CodeProdigee.API.Models.CommentReply", null)
                        .WithMany("Reactions")
